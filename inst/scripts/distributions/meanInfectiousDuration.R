...
dataset <- "meanInfectiousDuration"
productStorageRoot <- "boydorr"
path <- file.path("parameters", "meanInfectiousDuration", "meanInfectiousDuration.toml")
namespace <- "SCRC"
productVersion <- "0.1.0"
filename <- "meanInfectiousDuration.toml"
...
create_distribution(filename = "meanInfectiousDuration.toml",
                    descriptor = "meanInfectiousDuration",
                    distribution = "Lognormal",
                    parameters = list(meanlog = 321.6))
