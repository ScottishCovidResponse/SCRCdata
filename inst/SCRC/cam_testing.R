#' coronavirus-covid-19-management-information testing data
#'
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information testing data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/testing"
...
submission_script <- "cam_testing.R"
