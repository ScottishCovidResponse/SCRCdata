#' coronavirus-covid-19-management-information nhs workforce data
#'
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information nhs workforce data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/nhsworkforce"
...
submission_script <- "cam_nhsworkforce.R"
