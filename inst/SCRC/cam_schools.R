#' coronavirus-covid-19-management-information schools data
#'
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information schools data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/schools"
...
submission_script <- "cam_schools.R"
