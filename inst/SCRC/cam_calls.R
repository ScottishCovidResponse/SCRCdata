#' coronavirus-covid-19-management-information calls data
#'
...
#'
#' This dataset is no longer updated as of 22/07
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information calls data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/calls"
