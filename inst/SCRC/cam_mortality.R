#' coronavirus-covid-19-management-information mortality data
#'
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information mortality data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/mortality"
...
submission_script <- "cam_mortality.R"
