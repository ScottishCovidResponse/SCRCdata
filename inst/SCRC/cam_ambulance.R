...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information ambulance data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/ambulance"
...
submission_script <- "cam_ambulance.R"
