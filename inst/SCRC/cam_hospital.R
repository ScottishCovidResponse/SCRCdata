#' coronavirus-covid-19-management-information hospital data
#'
...
doi_or_unique_name <- "scottish coronavirus-covid-19-management-information hospital data"
...
# ../../srv/ftp/scrc/[product_name]
product_name <- "records/SARS-CoV-2/scotland/cases-and-management/hospital"
...
submission_script <- "cam_hospital.R"
